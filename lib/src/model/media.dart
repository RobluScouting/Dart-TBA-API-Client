...
abstract class Media implements Built<Media, MediaBuilder> {
  ...
  // enum typeEnum {  youtube,  cdphotothread,  imgur,  facebook-profile,  youtube-channel,  twitter-profile,  github-profile,  instagram-profile,  periscope-profile,  gitlab-profile,  grabcad,  instagram-image,  external-link,  avatar,  };
...
class MediaTypeEnum extends EnumClass {
  ...
  /// String type of the media element.
  @BuiltValueEnumConst(wireName: r'gitlab-profile')
  static const MediaTypeEnum gitlabProfile = _$mediaTypeEnum_gitlabProfile;
