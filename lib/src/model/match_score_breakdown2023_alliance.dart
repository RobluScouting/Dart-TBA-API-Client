...
abstract class MatchScoreBreakdown2023Alliance implements Built<MatchScoreBreakdown2023Alliance, MatchScoreBreakdown2023AllianceBuilder> {
  ...
  @BuiltValueField(wireName: r'extraGamePieceCount')
  int? get extraGamePieceCount;
...
class _$MatchScoreBreakdown2023AllianceSerializer implements PrimitiveSerializer<MatchScoreBreakdown2023Alliance> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.extraGamePieceCount != null) {
      yield r'extraGamePieceCount';
      yield serializers.serialize(
        object.extraGamePieceCount,
        specifiedType: const FullType(int),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'endGameParkPoints':
          ...
          break;
        case r'extraGamePieceCount':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(int),
          ) as int;
          result.extraGamePieceCount = valueDes;
          break;
        case r'foulCount':
          final valueDes = serializers.deserialize(
            value,
