...
class _$DistrictRankingSerializer implements StructuredSerializer<DistrictRanking> {
  ...
  Iterable<Object?> serialize(Serializers serializers, DistrictRanking object,
    ...
    if (object.rookieBonus != null) {
      result..add(r'rookie_bonus')..add(serializers.serialize(object.rookieBonus, specifiedType: const FullType(int)));
    }
    result..add(r'point_total')..add(serializers.serialize(object.pointTotal, specifiedType: const FullType(int)));
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case r'rank':
          ...
          break;
        case r'rookie_bonus':
          result.rookieBonus = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'point_total':
          result.pointTotal = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case r'event_points':
