  ...
  Iterable<Object?> serialize(Serializers serializers, EliminationAllianceStatus object,
    ...
    if (object.playoffAverage != null) {
      result
        ...
        ..add(serializers.serialize(object.playoffAverage, specifiedType: const FullType(double)));
    }
    if (object.level != null) {
      result..add(r'level')..add(serializers.serialize(object.level, specifiedType: const FullType(String)));
    }
    ...
    if (object.status != null) {
      result..add(r'status')..add(serializers.serialize(object.status, specifiedType: const FullType(String)));
    }
    return result;
  }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case r'playoff_average':
          result.playoffAverage = serializers.deserialize(value, specifiedType: const FullType(double)) as double;
          break;
        case r'level':
          result.level = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case r'record':
