...
abstract class TeamEventStatusRankRanking
    implements Built<TeamEventStatusRankRanking, TeamEventStatusRankRankingBuilder> {
  ...
  factory TeamEventStatusRankRanking([void updates(TeamEventStatusRankRankingBuilder b)]) =
...
class _$TeamEventStatusRankRankingSerializer implements StructuredSerializer<TeamEventStatusRankRanking> {
  ...
  Iterable<Object?> serialize(Serializers serializers, TeamEventStatusRankRanking object,
    ...
    if (object.qualAverage != null) {
      result
        ..add(r'qual_average')
        ..add(serializers.serialize(object.qualAverage, specifiedType: const FullType(double)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case r'matches_played':
          ...
          break;
        case r'qual_average':
          result.qualAverage = serializers.deserialize(value, specifiedType: const FullType(double)) as double;
          break;
        case r'sort_orders':
