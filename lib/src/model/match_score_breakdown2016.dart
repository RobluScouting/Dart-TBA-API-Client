...
class _$MatchScoreBreakdown2016Serializer implements StructuredSerializer<MatchScoreBreakdown2016> {
  ...
  Iterable<Object?> serialize(Serializers serializers, MatchScoreBreakdown2016 object,
    ...
    if (object.blue != null) {
      result
        ..add(r'blue')
        ..add(serializers.serialize(object.blue, specifiedType: const FullType(MatchScoreBreakdown2016Alliance)));
    }
    if (object.red != null) {
      result
        ..add(r'red')
        ..add(serializers.serialize(object.red, specifiedType: const FullType(MatchScoreBreakdown2016Alliance)));
    }
    return result;
  }
