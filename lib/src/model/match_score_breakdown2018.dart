...
class _$MatchScoreBreakdown2018Serializer implements StructuredSerializer<MatchScoreBreakdown2018> {
  ...
  Iterable<Object?> serialize(Serializers serializers, MatchScoreBreakdown2018 object,
    ...
    if (object.blue != null) {
      result
        ..add(r'blue')
        ..add(serializers.serialize(object.blue, specifiedType: const FullType(MatchScoreBreakdown2018Alliance)));
    }
    if (object.red != null) {
      result
        ..add(r'red')
        ..add(serializers.serialize(object.red, specifiedType: const FullType(MatchScoreBreakdown2018Alliance)));
    }
    return result;
  }
